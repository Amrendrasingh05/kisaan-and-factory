          ...
          <nav className="navbar">
            <div className="container-fluid">
              <div className="d-flex align-items-center col-xs-6 col-sm-3">
                ...
                <p className="location  animate__animated animate__pulse animate__infinite	infinite" id="getLoc">
              ...
              <div className="d-flex align-items-center justify-content-between  col-xs-6 col-sm-9">
                    {/* <SwitchBtn/> */}
                <form className="d-flex search animate__animated animate__fadeInLeft" onSubmit={SearchProduct}>
                  <input
                    className="form-control me-0 ms-2"
                    autoComplete="off"
                    type="search"
                    placeholder="Find Grocery, clothings, Accessories..."
                    onChange={(e) => {
